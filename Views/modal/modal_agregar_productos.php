        ...
        <div class="col-md-6">
         <?php  $consul = $conexion->query("SELECT * FROM usuarios");  ?>
          ...
          <select class="form-control chosen-select" id="idcategoria" name="producto[]">
           <option value=""  required="" >BEBIDAS</option> 
...
<br>
     <div class="col-md-6">
            ...
            ?>
          <select class="form-control chosen-select" id="idcategoria" name="producto[]">
           <option value="0"  required="" >PLATO DE CARNE</option> 
                <?php foreach ($consul as $fila): ?>
             <option value="<?php echo $fila['idproducto']. '-' .  $fila['precio'] ?>"> <?php echo ucwords($fila['nombreproducto'])?> 
            </option>
              <?php endforeach ?>
...
<br><br>
     ...
     <?php             
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="agregarBebidas" id="agregarBebidas" class="btn btn-success">Agregar</button>
      </div>
     </form>
    </div>
  </div>
